...
object Versions {
    ...
    const val androidxComposeCompiler = "1.3.0"
    const val androidxComposeMaterial3 = "1.0.0-beta01"
    ...
    const val jbAnnotations = "23.0.0"
    const val androidDeviceNames = "2.1.0"
    const val byteBuddy = "1.12.2"
