...
class AppPackageInfo(private val context: Context, private val appInfo: ApiViewingApp) :
    CompactPackageInfo {
    ...
    override fun loadUnbadgedIcon(pm: PackageManager): Drawable {
        val app = appInfo.getApplicationInfo(context) ?: throw Exception("Application info is null")
