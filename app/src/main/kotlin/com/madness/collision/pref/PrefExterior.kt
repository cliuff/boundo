...
import com.madness.collision.settings.ExteriorSettingsFragmentDirections
    ...
    override fun onPreferenceTreeClick(preference: Preference?): Boolean {
        ...
        return when(preference.key){
            getString(R.string.prefExteriorKeyBack) -> {
                findNavController().navigate(ExteriorSettingsFragmentDirections.actionExteriorSettingsFragmentToExteriorFragment(ExteriorFragment.MODE_LIGHT))
                true
            }
            getString(R.string.prefExteriorKeyBackDark) -> {
                findNavController().navigate(ExteriorSettingsFragmentDirections.actionExteriorSettingsFragmentToExteriorFragment(ExteriorFragment.MODE_DARK))
                true
            }
            keyLightTheme -> {
